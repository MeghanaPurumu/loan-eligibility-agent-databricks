...
# Reconstruct obfuscated token if parts exist and DATABRICKS_TOKEN is not already in environment
if not os.environ.get("DATABRICKS_TOKEN") or os.environ.get("DATABRICKS_TOKEN") == "dapi_placeholder_token":
